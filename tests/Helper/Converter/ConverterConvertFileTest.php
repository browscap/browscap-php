...
final class ConverterConvertFileTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testConvertMissingFile() : void
    {
        ...
        $object = new Converter($logger, $cache);

        $this->expectException(FileNotFoundException::class);
        $this->expectExceptionMessage('testFile');

        $object->convertFile('testFile');
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function testConvertMissingFile2() : void
    {
        /** @var LoggerInterface|\PHPUnit\Framework\MockObject\MockObject $logger */
        $logger = $this->createMock(LoggerInterface::class);
        $logger->expects(static::never())
...
';
        ...
        $object->convertFile(vfsStream::url(self::STORAGE_DIR . \DIRECTORY_SEPARATOR . 'test.ini'));
    }
